...
status: active
type: how-to
description: Instructions for the Markov Chain Analysis Agent — tracking and exposing Markov properties of the learning dynamics for convergence, equilibrium, and absorption analysis.
label: [agent, skill]
injection: directive
volatility: evolving
...
When implementing MC analysis features, log in `worklog.jsonl`:
